...
urlpatterns = [
    ...
    path("admin/app", BookingHomeView.as_view(), name="admin_dashboard"),
    path("admin/app/list", BookingListView.as_view(), name="booking_list"),
    path("admin/app/settings", BookingSettingsView.as_view(), name="booking_settings"),
    path("admin/app/<pk>/delete",
         BookingDeleteView.as_view(), name="booking_delete"),
    path("admin/app/<pk>/approve",
